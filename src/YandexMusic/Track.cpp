...
namespace yandex_music {
    ...
    Track::Track(
            ...
            : id(std::move(id_)), title(std::move(title_)), artists(std::move(artists_)), albums(std::move(albums_)),
              available(available_), lyrics_available(lyrics_available_), supplement() {}
